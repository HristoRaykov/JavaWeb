...
public class UserRegisterBean extends BaseBean {
    ...
    public void register() {
        ...
        userServiceModel.setGender(Gender.valueOf(userRegisterBindingModel.getGender().toUpperCase()));
        Optional<UserServiceModel> userServiceModelOptional = this.userService.createUser(userServiceModel);
